(() => {
    var __webpack_modules__ = {
        ...
        775: function(__unused_webpack_module, exports) {
 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slide-block__slider")) new core(".slide-block__slider", {
                ...
                simulateTouch: false,
                pagination: {
                    el: ".slide-block__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slide-block__prev-btn",
                    nextEl: ".slide-block__next-btn"
                },
                breakpoints: {
                    581: {
                        slidesPerView: 2
            ...
            if (document.querySelector(".slide-block__slider--triple")) new core(".slide-block__slider--triple", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        const esm = flatpickr;
        var ru = __webpack_require__(775);
        esm("#calendarInput", {
            dateFormat: "d.m.Y",
            locale: ru.Russian,
            position: "below",
        ...
        function swapSelectedValues(select1, select2) {
            const selectedValues1 = Array.from(select1.options).filter((option => option.selected)).map((option => option.value));
            const selectedValues2 = Array.from(select2.options).filter((option => option.selected)).map((option => option.value));
            ...
            Array.from(select1.options).forEach((option => {
                if (selectedValues2.includes(option.value)) option.selected = true;
            }));
            Array.from(select2.options).forEach((option => {
                if (selectedValues1.includes(option.value)) option.selected = true;
            }));
            flsModules.select.selectBuild(select1);
            flsModules.select.selectBuild(select2);
        }
        const swapBtn = document.querySelector(".tickets__switch-btn");
